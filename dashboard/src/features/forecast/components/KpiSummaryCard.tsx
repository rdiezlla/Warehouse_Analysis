...
export const KpiSummaryCard = ({ model }: KpiSummaryCardProps) => (
  <article className="group rounded-2xl border border-white/60 bg-white/95 p-5 shadow-[0_12px_28px_-20px_rgba(15,23,42,0.45)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_30px_-18px_rgba(15,23,42,0.3)]">
